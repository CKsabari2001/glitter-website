...
function SignupForm({ opensignup, signupHandler }: Props) {
  return (
    <div>
      <Modal
          ...
          <Grid container spacing={0}>
            ...
            <Grid item xs={12} sm={6}>
              <div className="form-container">
                ...
                <p className="modal-paragraph">Signup with Email</p>
                <Grid
                  container
                  rowSpacing={4}
                ...
                >
                  ...
                  <Grid item xs={10} className="login-with">
                    <p className="modal-paragraph">Or Signup with</p>
                ...
                <a onClick={signupHandler} className="close-button">
